...
- In URI paste this url: https://github.com/prashantsingh-01/Ecommerce-Java
  -> Next
...
- Open Project > open com.conn package > open DBConnect.java file.
  ...
  like if it is
   ...
   conn = DriverManager.getConnection("jdbc:sqlite:C:/Users/Prashant/eclipse- 
   workspace/Online Electronic Shopping/mydatabase.db");
...
### Project Creator: Prashant Singh
